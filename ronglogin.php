...
<body>
<div id="contenido" style="margin:0 auto 0 auto; width: 400px">
<div style="margin: 0 auto; width: 200px">
<form ACTION="<?php echo $loginFormAction; ?>" id="form1" name="form1" method="POST"><table width="200" border="0">
  <tbody>
    <tr>
  ...
  <input name="textfield" type="text" autofocus="autofocus" id="textfield" tabindex="1" autocomplete="off"></td>
    </tr>
    <tr>
