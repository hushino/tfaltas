...
$xreinciletras = 'más de la cuarta';
$art82rein = '4';
break;
...
<div id="contenido">
  ...
  <?php } // Show if recordset not empty ?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>Expte. NÂº <?php echo $row_causa['EXPTE']; ?> - AÃ±o <?php $date1=date_create($row_causa['FECHASIEN']); echo date_format($date1,'Y'); ?><br><?php $date2=date_create($row_causa['INFFECHA']); echo 'Fecha de la infracc.: ' . date_format($date2,'d-m-Y'); ?></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
...
<tr>
            <td><?php if ($totalRows_antec2 >= 1) { ?><?php echo 'Antecedentes: ' . ($totalRows_antec2-1) . ' - - - Reincidencias: ' . $row_canant['sumasC'];?><?php } ?>
            ...
            <td><?php if ($totalRows_canant >= 1) { ?><?php echo '$ ' . ($row_summultas['UTXSUM'] * $antemulti); ?><?php } ?></td>
            <td>&nbsp;<?php if ($totalRows_canant >= 1) { ?><?php echo '$ ' . (($row_summultas['UTXSUM'] * $antemulti) / 2); ?><?php } ?></td>
          </tr>
          <tr>
