...
<div id="contenido">Ingresar Numero de D.N.I.<br>
  ...
  <input name="DNI" type="search" autofocus autocomplete="off" id="DNI" placeholder="ingresar DNI" size="60" required>   <br>
  <input name="nombres" type="search" autocomplete="off" id="nombres" placeholder="ingresar NOMBRES y APELLIDOS" size="60" required>   <br>
  <input name="domic" type="search" autocomplete="off" id="domic" placeholder="ingresar domicilio" size="60" required>   <br>
  <br>
