...
?>
	...
	<tr id="filaActaInfr">
	  <td style="width: 200px; text-align: right;">
	    Nº de expediente:
	    <input name="IDx" type="text" required="required" id="IDxx" style="width:100px;" tabindex="1" autocomplete="off" readonly /></td>
	  <td style="width: 200px;"><span style="width:100px;">Acta de Inf. Nº</span>	    <input name="infacta" type="text" required="required" autofocus id="infacta" style="width:100px;" tabindex="1" onFocusOut="javascript:verificar()" autocomplete="off" /><div id="final"></div></td></tr>
	<tr id="filaActaInfr">
...
?>
          ...
          <b>Dominio</b>:
		<input name="infautopat" type="text" id="infautopat" style="width:70px; text-transform:uppercase;" tabindex="7" title="sólo 7 letras o números. Las letras en mayúsculas" maxlength="7" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off"/><?php //pattern="[A-Z0-9]{7}"  ?></td>
	</tr>
      <tr>
        <td>Oblada
          <label for="infvehi2">
            <input name="oblada" type="checkbox" id="oblada" title="Marcar si surge pago espontáneo del acta" value="S" onchange="javascript:showContent()"><div id="contoblada" style="display: none; text-align: left; ">
...
?>
          </select><br>Recibo: <input name="obladarec" type="text" id="obladarec" style="width:150px;" title="Ingresar el Número de Recibo." /></div>
            </td><td>Retención Licencia
