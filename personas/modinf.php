...
do {
?>
	      <option value="<?php echo $row_depend['IDC']?>"<?php if (!(strcmp($row_depend['IDC'], $row_modinf['DEPORIG']))) {echo "selected=\"selected\"";} ?>><?php echo $row_depend['DETALLES']?></option>
	      <?php
...
?>
	...
	<tr id="filaActaInfr">
	  <td style="width: 200px; text-align: right;">Nº de expediente:
	    <input name="IDx" type="text" autofocus required="required" id="IDxx" style="width:100px;" tabindex="1" autocomplete="off" value="<?php echo $row_modinf['ID']; ?>" readonly /></td>
	  <td style="width: 200px;"><span style="width:100px;">Acta de Inf. Nº</span>	    <input name="infacta" type="text" required="required" id="infacta" style="width:100px;" tabindex="1" autocomplete="off" value="<?php echo $row_modinf['INFACTA']; ?>" /></td></tr>
	<tr id="filaActaInfr">
	  <td style="width: 200px; text-align: right;">Fecha	    <input name="inffecha" type="date" required="required" id="infdate" style="width: 130px;" tabindex="2" autocomplete="off" value="<?php echo $row_modinf['INFFECHA']; ?>"/></td>
	  <td style="width: 200px; text-align: right;"><b>Hora</b>	    <input name="infhora" type="time" required="required" id="infhora" style="width:70px;" tabindex="3" autocomplete="off" value="<?php echo $row_modinf['INFHORA']; ?>" /></td></tr>
      <tr>
        <td colspan="2">Lugar en que se cometió la falta
          <input name="influg" type="text" required="required" id="influg" style="width:315px;" tabindex="4" autocomplete="off" value="<?php echo $row_modinf['INFLUG']; ?>" /></td>
      </tr>
    <tr>
      ...
      <tr>
		<td colspan="2" align="right"><label for="infvehi">Tipo de Vehículo:</label>
          <select name="infvehi" id="infvehi" value="<?php echo $row_modinf['INFVEHI']; ?>" style="width:100px;" tabindex="6">
            <?php
do {
?>
            <option value="<?php echo $row_opvehi['IDC']?>"<?php if (!(strcmp($row_opvehi['IDC'], $row_modinf['INFVEHI']))) {echo "selected=\"selected\"";} ?>><?php echo $row_opvehi['DETALLES']?></option>
            <?php
...
?>
          ...
          <b>Dominio</b>:
		<input name="infautopat" type="text" id="infautopat" style="width:70px;" tabindex="7" title="sólo 7 letras o números. Las letras en mayúsculas" value="<?php echo $row_modinf['INFAUTOPAT']; ?>" maxlength="7" /><?php // pattern="[A-Z0-9]{7}" ?></td>
	</tr>
    <tr>
        <td>Oblada
            <input <?php if (!(strcmp($row_modinf['OBLADA'],"S"))) {echo "checked=\"checked\"";} ?> name="oblada" type="checkbox" id="oblada" title="Marcar si surge pago espontáneo del acta" value="S" onchange="javascript:showContent()">
            <div id="contoblada" <?php if (!(strcmp($row_modinf['OBLADA'],"S"))) {echo "style=\"display: block; text-align: left; \"";} else {echo "style=\"display: none; text-align: left; \"";} ?> >
          <select name="infpago" id="infpago" style="width:150px;" tabindex="6">
            <?php do { ?>
            <option value="<?php echo $row_oppago['IDC']?>"<?php if (!(strcmp($row_oppago['IDC'], $row_modinf['OBLATIPO']))) {echo "selected=\"selected\"";} ?>><?php echo $row_oppago['DETALLES']?></option>
            <?php
...
?></select><br>Recibo: <input name="obladarec" type="text" id="obladarec" style="width:150px;" title="Ingresar el Número de Recibo." value="<?php echo $row_modinf['OBLANRO']; ?>" /></div>
        </td>
        <td>Retención Licencia
  <input <?php if (!(strcmp($row_modinf['RETLICE'],"S"))) {echo "checked=\"checked\"";} ?> name="retlice" type="checkbox" id="retlice" value="S">
  Retención de Vehículo
  <input <?php if (!(strcmp($row_modinf['RETVEHI'],"S"))) {echo "checked=\"checked\"";} ?> name="retvehi" type="checkbox" id="retvehi" value="S">
          </label></td>
      </tr>
    <tr>
		<td colspan="2">Observaciones
		  <input name="infobser" type="text" id="infobser" style="width: 380px;" tabindex="8" autocomplete="off" value="<?php echo $row_modinf['INFOBSER']; ?>" /></td>
	</tr>
</table>
</fieldset>
</div>
...
<legend class="ui-widget-header ui-corner-all ui-state-highlight" style="padding:1px 10px;" id="grupoDomicilio">Datos Personales</legend><table class="formulario" style="width: 45%; text-align: justify;">
	<tr>
	  <th style="width:40px;" id="tituloApellido">Apellidos</th><td><input name="apellidos" type="text" id="apellido" style="width:205px;" tabindex="9" autocomplete="off" value="<?php echo $row_modinf['APELLIDOS']; ?>" /></td></tr>
	<tr>
	  <th style="width:40px;">Nombres</th><td><input name="nombres" type="text" id="nombres" style="width:205px;" tabindex="10" autocomplete="off" value="<?php echo $row_modinf['NOMBRES']; ?>" /></td></tr>
      <tr>
        <th style="width:40px;">D.N.I.</th>
        <td><input name="dni" type="text" id="dni" style="width:85px;" tabindex="11" autocomplete="off" value="<?php echo $row_modinf['DNI']; ?>" /></td>
      </tr>
      <tr>
	  <th style="width:50px;">Doc.Nac.</th><td><input name="dninac" type="text" id="dninac" style="width: 50px; float: left;" pattern="[A-Z]{3}" tabindex="11" autocomplete="off" value="<?php echo $row_modinf['DNINAC']; ?>" /></td></tr>
</table></fieldset></div>
...
<table class="formulario" style="width:30%;">
	...
	<tr>
	  <th style="width:30px;">Calle o Barrio</th><td><input name="dirCalle" type="text" id="dirCalle" style="width:200px;" tabindex="12" autocomplete="off" value="<?php echo $row_modinf['DIRCALLE']; ?>" /></td></tr>
	<tr>
		<th style="width:30px;">Nro.</th><td><input name="dirNro" type="text" id="dirNro" style="width:36px;" tabindex="13" autocomplete="off" value="<?php echo $row_modinf['DIRNRO']; ?>" />
		<b>&nbsp;&nbsp;&nbsp;Piso&nbsp;&nbsp;</b><input name="dirPiso" type="text" id="dirPiso" style="width:30px;" tabindex="14" autocomplete="off" value="<?php echo $row_modinf['DIRPISO']; ?>" />
		...
		<td><input name="dirMz" type="text" id="dirMz" style="width:36px;" tabindex="16" autocomplete="off" value="<?php echo $row_modinf['DIRMZ']; ?>" />
		<b>&nbsp;&nbsp;&nbsp;Casa&nbsp;</b>
		<input name="dirCs" type="text" id="dirCs" style="width:30px;" tabindex="17" autocomplete="off" value="<?php echo $row_modinf['DIRCS']; ?>" />
		<b>&nbsp;&nbsp;&nbsp;Mbk.&nbsp;&nbsp;</b>
		<input name="dirMbk" type="text" id="dirMbk" style="width:30px;" tabindex="18" autocomplete="off" value="<?php echo $row_modinf['DIRMBK']; ?>" /></td>
	</tr>
	<tr id="filaLocalidad"><th style="width:30px;">Localidad</th><td><input name="localidad" type="text" id="localidad" style="width:200px;" tabindex="19" value="<?php echo $row_modinf['LOCALIDAD']; ?>" /></td></tr>
    <tr><th style="width:30px;">Provincia</th><td><input type="hidden" name="idProvincia" id="idProvincia" /><input name="descProvincia" type="text" id="descProvincia" style="width:200px;" tabindex="20" value="<?php echo $row_modinf['DESCPROVINCIA']; ?>" /></td></tr>
...
<table align="center" border="0">
	<tr>
		<td><a href="../exptes/expte.php?exp=<?php echo $row_modinf['ID']; ?>"><input type="button" name="button" id="button" value=" ir a la causa " ></a></td>
