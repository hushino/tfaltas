...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formulario")) {
  $insertSQL = sprintf("INSERT INTO listainfractor (NRORESOL, APELLIDOS, NOMBRES, DNI, TIPINFRAC, NROCAUSA, RESFECHA, INFRACC, DEPORIG, DNINAC) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$updateSQL2 = sprintf("UPDATE causas SET RES_DEFINI = 'S', RES_DEFININRO = Concat(RES_DEFININRO,', ',%s) WHERE ID = %s",
                       GetSQLValueString($_POST['resolnro'], "text"),
                       GetSQLValueString($_POST['IDx'], "int"));
...
$colname_cauresol = "-1";
if (isset($_GET['exp'])) {
  $colname_cauresol = $_GET['exp'];
}
mysql_select_db($database_tfx, $tfx);
$query_cauresol = sprintf("SELECT * FROM causas WHERE ID = %s", GetSQLValueString($colname_cauresol, "int"));
...
<table width="400" border="0" cellspacing="1" class="formulario" style="width: 95%; text-align: right;">
	...
	<tr id="filaActaInfr">
	  <td style="width: 200px; text-align: right;">
	    N潞 de expediente:
	    <input name="IDx" type="text" required="required" id="IDxx" style="width:100px;" tabindex="1" autocomplete="off" value="<?php echo $row_cauresol['ID']; ?>" readonly /></td>
	  <td style="width: 200px;"><span style="width:100px;">Acta de Inf. N潞</span>	    <input name="infacta" type="text" required="required" id="infacta" style="width:100px;" tabindex="1" autocomplete="off" value="<?php echo $row_cauresol['INFACTA']; ?>" readonly onFocusOut="javascript:verificar()" /><div id="final"></div></td></tr>
	<tr id="filaActaInfr">
	  <td style="width: 200px; text-align: right;">Fecha	    </td>
	  <td style="width: 200px; text-align: right;"><b>Hora</b></td></tr>
      <tr>
        <td colspan="2">Lugar en que se cometi贸 la falta          </td>
      </tr>
    <tr>
      <td colspan="2" align="left" style="width:auto;">Infracci贸n<br>
...
<legend class="ui-widget-header ui-corner-all ui-state-highlight" style="padding:1px 10px;" id="grupoApellidoNombre">Datos de la Resolucion</legend>

<fieldset class="ui-widget ui-widget-content ui-corner-all" style="width: 200px; margin-left: auto; margin-right: auto;">
<legend class="ui-widget-header ui-corner-all ui-state-highlight" style="padding:1px 10px;" id="grupoDomicilio">Datos Pde la Resoluci髇 a cargar</legend><table class="formulario" style="width: 45%; text-align: justify;">
	<tr>
	  <th style="width:40px;" id="tituloApellido3">Nro. de resoluci贸n</th>
	  <td><input name="resolnro" type="text" autofocus required id="resolnro" style="width:205px;" tabindex="9" autocomplete="off" /></td>
	  </tr>
	<tr>
	  <th style="width:40px;" id="tituloApellido2">Fecha</th>
	  <td><input name="resolfecha" type="date" required id="resolfecha" style="width:205px;" tabindex="9" autocomplete="off" value="" /></td>
	  </tr>
	<tr>
	  <th style="width:40px;" id="tituloApellido4">&nbsp;</th>
	  <td><p>
	    <label>
	      <input type="radio" name="RadioGroup1" value="Sobreseido" id="RadioGroup1_0">
	      Sobreseido</label>

	    <label>
	      <input type="radio" name="RadioGroup1" value="Desestimado" id="RadioGroup1_1">
	      Desestimado</label>
	    <br>
            <label>
	      <input type="radio" name="RadioGroup1" value="Prescripto" id="RadioGroup1_1">
	      Prescripto</label>
	    <label>
	      <input type="radio" name="RadioGroup1" value="Incompetente" id="RadioGroup1_1">
	      Incompetente</label>
            <label>
	      <input type="radio" name="RadioGroup1" value="Otros" id="RadioGroup1_1">
	      Otros</label>
	    <br>
	    </p></td>
	  </tr>
...
<table align="center" id="controles_mensaje" style="display:none;">
	<tr>
		<td><a href="../personas/verMenuEmpleado.do" id="btn_volver_menu">Men煤 Principal</a></td>
	</tr>
</table>
</div>
