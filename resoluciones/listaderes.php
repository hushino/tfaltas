...
<div id="contenido"><fieldset><legend>Lista de Resoluciones</legend>
    ...
    <table width="100%" border="1">
      <tbody>
        ...
        <?php do { ?><tr>
          ...
          <td><a href="mod-resolu.php?idres=<?php echo $row_listaresol['IDRES']; ?>"><img src="../images/flechita.png" width="16" height="18" alt=""/></a></td>
          <td>&nbsp;</td>
          </tr>
        <?php } while ($row_listaresol = mysql_fetch_assoc($listaresol)); ?><tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
